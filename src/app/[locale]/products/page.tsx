...
export const placeholderProducts = [
  ...
  { id: '2', name: 'Corn Pasta', category: 'Pasta', imageUrl: 'https://placehold.co/300x200.png', description: 'Authentic Italian corn pasta, naturally gluten-free.', dataAiHint: 'pasta corn', isGlutenFree: true, ingredients: 'Corn Flour (100%). May contain traces of soy.', nutriScore: 'A', isLactoseFree: true, isSugarFree: true, isPosno: true },
  { id: '3', name: 'Rice Cakes', category: 'Snacks', imageUrl: 'https://placehold.co/300x200.png', description: 'Light and crispy rice cakes, perfect for snacking.', dataAiHint: 'rice cakes', isGlutenFree: true, ingredients: 'Whole Grain Brown Rice, Sea Salt.', nutriScore: 'A', isLactoseFree: true, isSugarFree: true, isPosno: true },
  ...
  { id: '5', name: 'Almond Flour Mix', category: 'Bakery', imageUrl: 'https://placehold.co/300x200.png', description: 'Versatile almond flour for baking.', dataAiHint: 'almond flour', isGlutenFree: true, ingredients: 'Blanched Almond Flour.', nutriScore: 'C', isLactoseFree: true, isSugarFree: true, isPosno: true },
  ...
  { id: '7', name: 'Regular Wheat Bread', category: 'Bakery', imageUrl: 'https://placehold.co/300x200.png', description: 'Traditional wheat bread.', dataAiHint: 'wheat bread', isGlutenFree: false, ingredients: 'Wheat Flour, Water, Yeast, Salt, Sugar. Contains: Wheat.', nutriScore: 'D', isLactoseFree: false, isSugarFree: false, isPosno: false },
];
