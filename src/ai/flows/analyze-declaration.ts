...
*   **Specifični sastojci za Narandžastu listu (primeniti Opšte pravilo uz dodatne napomene FOKUSIRANE NA GLUTEN):**
    ...
    *   **aroma / prirodna aroma**: Prati sledeću logiku:
        - Ako je navedeno samo "aroma" ili "prirodna aroma" bez specifikacije, a proizvod nema GF oznaku: 'ocena': "rizično – proveriti poreklo", 'nivoRizika': "umeren", 'kategorijaRizika': "aditiv (aroma - nepotvrđeno GF)", 'napomena': "Poreklo arome nije navedeno. Nosač arome može biti na bazi žitarica koje sadrže gluten."
        - Ako je poreklo jasno navedeno i bezglutensko (npr. "aroma (mleko)", "aroma vanile"): 'ocena': "sigurno", 'nivoRizika': "nizak". U 'napomena' navesti drugi alergen ako postoji.
        - Ako je aroma izvedena iz glutenskog izvora (npr. "aroma ječmenog slada"): 'ocena': "nije bezbedno", 'nivoRizika': "visok".
